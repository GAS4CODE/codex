...
{b}┃╰┻━┃╭╮┣━━┃╱╱┃┃╰━╯┃╰━╯┣╯╰╯┃╰━━┳╯╭╮╰╮
{h}╰━━━┻╯╰┻━━╯╱╱╰┻━━━┻━━━┻━━━┻━━━┻━╯╰━╯	
			{m}•{k}•{h}•{sir} Author : Gas4CODEX {x}{m}•{k}•{h}•{x}''')
#--------------------[ BAGIAN-MASUK ]--------------#
def login():
	try:
...
def menu(id):
	...
	print('>> 5. Hasil Crack  ')
	print('>> 0. Keluar       ')
	_____codex__codex_____ = input('\n>> Pilih : ')
	if _____codex__codex_____ in ['1']:
		dump_massal()
	elif _____codex__codex_____ in ['2']:
		dump_follower()
	elif _____codex__codex____ in ['3']:
		error()
	elif _____codex__codex_____ in ['4']:
		crack_file()
	elif _____codex__codex____ in ['5']:
		result()
	elif _____codex__codex_____ in ['0']:
